...
template<typename PointLoader>
void Line<PointLoader>::Draw( Point source, Point target, PointLoader &point_loader )
{
...
template <typename PointLoader>
void Line<PointLoader>::DrawFlatLine( Point source, Point target, PointLoader &point_loader )
{
